package com.warzone.edu_assist_domain_task;
...
public class Task {
	...
	private List<Task_Completion> task_Completions;
	...
	public List<Task_Completion> getTask_Completions() {
		return task_Completions;
	}
	public void setTask_Completions(List<Task_Completion> task_Completions) {
		this.task_Completions = task_Completions;
	}
